...
const PieChartData = [
    ...
    { name: "돈까스", value: 50, color: "warning" },
    { name: "만두", value: 30, color: "success" },
];
                    ...
                    >
                        ...
                        >
                            <Grid item xs={4}>
                                ...
                                <Typography size="md">821</Typography>
                            </Grid>
                            <Grid item xs={4}>
                                <Typography color="text" colorBrightness="secondary" noWrap>
                                    오늘
                                </Typography>
                                <Typography size="md">1032</Typography>
                            </Grid>
                            <Grid item xs={4}>
                                <Typography color="text" colorBrightness="secondary" noWrap>
                                    증가율
                                </Typography>
                                <Typography size="md">25.7%</Typography>
                            </Grid>
                        </Grid>
                    </Widget>
                </Grid>
